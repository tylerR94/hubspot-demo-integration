...
class HubdbDiscovery {
    constructor(config) {
        ...
        this.rowsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.RowsApi(configuration), configuration);
        this.rowsBatchApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.RowsBatchApi(configuration), configuration);
        this.tablesApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.TablesApi(configuration), configuration);
    }
}
