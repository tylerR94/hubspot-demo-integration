...
class FilesDiscovery {
    constructor(config = {}) {
        ...
        this.filesApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.FilesApi(configuration), configuration);
        this.foldersApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.FoldersApi(configuration), configuration);
    }
}
