...
class PipelinesDiscovery {
    constructor(config) {
        ...
        this.pipelineAuditsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.PipelineAuditsApi(configuration), configuration);
        this.pipelineStageAuditsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.PipelineStageAuditsApi(configuration), configuration);
        this.pipelineStagesApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.PipelineStagesApi(configuration), configuration);
        this.pipelinesApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.PipelinesApi(configuration), configuration);
    }
}
