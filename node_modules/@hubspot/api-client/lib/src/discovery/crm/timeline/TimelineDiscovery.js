...
class TimelineDiscovery {
    constructor(config) {
        ...
        this.eventsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.EventsApi(configuration), configuration);
        this.templatesApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.TemplatesApi(configuration), configuration);
