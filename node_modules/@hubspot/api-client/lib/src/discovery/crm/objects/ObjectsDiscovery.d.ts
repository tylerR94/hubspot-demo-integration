import { AssociationsApi, BasicApi, BatchApi, GDPRApi, PublicObjectApi, SearchApi } from '../../../../codegen/crm/objects/index';
...
export default class ObjectsDiscovery extends BaseDiscovery {
    ...
    get calls(): CallsDiscovery;
    get emails(): EmailsDiscovery;
    get feedbackSubmissions(): FeedbackSubmissionsDiscovery;
    get meetings(): MeetingsDiscovery;
    get notes(): NotesDiscovery;
    get postalMail(): PostalMailDiscovery;
    get tasks(): TasksDiscovery;
}
