...
class CommunicationPreferencesDiscovery {
    constructor(config = {}) {
        ...
        this.definitionApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.DefinitionApi(configuration), configuration);
        this.statusApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.StatusApi(configuration), configuration);
    }
}
