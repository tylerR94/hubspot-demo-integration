...
class OauthDiscovery {
    constructor(config = {}) {
        ...
        this.accessTokensApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.AccessTokensApi(configuration), configuration);
        this.refreshTokensApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.RefreshTokensApi(configuration), configuration);
        this.tokensApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.TokensApi(configuration), configuration);
    }
