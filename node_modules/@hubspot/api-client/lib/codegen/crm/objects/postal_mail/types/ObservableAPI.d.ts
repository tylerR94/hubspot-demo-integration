...
export declare class ObservableAssociationsApi {
    ...
    archive(postalMail: number, toObjectType: string, toObjectId: number, _options?: Configuration): Observable<void>;
    create(postalMail: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Observable<LabelsBetweenObjectPair>;
    getAll(postalMail: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Observable<CollectionResponseMultiAssociatedObjectWithLabelForwardPaging>;
}
