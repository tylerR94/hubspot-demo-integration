...
export declare class PromiseAssociationsApi {
    ...
    archive(postalMail: number, toObjectType: string, toObjectId: number, _options?: Configuration): Promise<void>;
    create(postalMail: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Promise<LabelsBetweenObjectPair>;
    getAll(postalMail: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<CollectionResponseMultiAssociatedObjectWithLabelForwardPaging>;
}
