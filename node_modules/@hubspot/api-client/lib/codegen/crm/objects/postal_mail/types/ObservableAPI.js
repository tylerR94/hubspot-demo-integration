...
class ObservableAssociationsApi {
    ...
    archive(postalMail, toObjectType, toObjectId, _options) {
        const requestContextPromise = this.requestFactory.archive(postalMail, toObjectType, toObjectId, _options);
    ...
    create(postalMail, toObjectType, toObjectId, associationSpec, _options) {
        const requestContextPromise = this.requestFactory.create(postalMail, toObjectType, toObjectId, associationSpec, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getAll(postalMail, toObjectType, after, limit, _options) {
        const requestContextPromise = this.requestFactory.getAll(postalMail, toObjectType, after, limit, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
